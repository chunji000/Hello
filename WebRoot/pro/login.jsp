...
function loadimage(){
	document.getElementById("randImage").src = "pro/image.jsp?"+Math.random();
...
function check(){
	...
	<body>
		<div class="login-box">
			...
			<form action="admin?method=login" method="post" onsubmit="return check();">
				<table>
					<tr class="name">
						<td>
							<label>
					...
					<tr class="code">
						...
						<td>
							<input class="text" style="margin-right: 10px;" type=text
								value="${imageCode }" name="imageCode" id="imageCode">
							<img onclick="javascript:loadimage();" title="换一张试试"
								name="randImage" id="randImage" src="pro/image.jsp" border="1"
								align="absmiddle">
						</td>
					</tr>
					<tr>
